...
public class WorkspaceServiceTerminationTest {
    ...
    public void publishesStoppedWorkspaceStoppedEventsAsServiceItemStoppedEvents() throws Exception {
        ...
        verify(eventService).publish(new ServiceItemStoppedEvent("workspace", "id1", 1, 3));
        verify(eventService).publish(new ServiceItemStoppedEvent("workspace", "id2", 2, 3));
        verify(eventService).publish(new ServiceItemStoppedEvent("workspace", "id3", 3, 3));
    }
